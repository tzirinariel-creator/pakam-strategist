  ...
  return (
    <div className="bg-mesh space-y-8 p-4 md:p-6">
      ...
      {/* ==================================================================
          ...
          זו לצד זו". */}
      {/* 4.9, L3 — הכרטיס הזה הוא מה שאריאל קרא: *"זה כתב לי שלא נשמרו
          קורסים"*. הוא נשען על `hasPlanData` בלבד, שהוא קאש של שאילתה אחת;
          כשהקאש מיושן הוא הכריז "התכנון לא נשמר" בזמן שהמד שמעליו, **על
          אותו מסך**, הראה 39 ש״ס ו-21 מתוכננים. השורש תוקן ב-`step-ready`,
          וכאן נסגרת הדלת: `hasAnyCourses` כבר מוגדר בקובץ וסופר גם ש״ס
          שנצברו ומתוכננים, אז הכרטיס לא יכול עוד לסתור את מה שלידו. */}
      {!tourOpen &&
        !wrapVisible &&
        planQuery.isSuccess &&
        !hasPlanData &&
