...
ציון בינארי (עובר/לא עובר): תקרה — 5 קורסים בתואר ראשון, 2 בתואר שני. לא יעלה על 10% מנ"ז בתואר ראשון, 20% בשני. לא ניתן להמיר: קורסי רישוי, קבלה לדוקטורט, עבודות סמינריוניות, קורסי מסלול גמר. הצטיינות — רק אם הבינאריים עד 25% ממכסת השעות השנתית.
