...
//
// Re-measured 5.9 and the number is UNCHANGED: 123 of 304 active courses.
// (A first pass counted 139/345 — that swept in the 42 inactive rows.
//  isActive is the filter the page uses, and the original figure stands.)
