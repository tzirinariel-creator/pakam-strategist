...
export function QuotaCard({
  ...
  const stepBtn =
    "flex size-6 items-center justify-center rounded-md border border-border/60 text-foreground/60 transition-colors hover:bg-foreground/5 hover:text-foreground/80 disabled:opacity-40 disabled:hover:bg-transparent";
  return (
