  ...
  return (
    <div className="data-card grid gap-6 p-6 sm:grid-cols-3">
      ...
      <div className="space-y-2">
        <span className="text-xs text-foreground/60">{t("summaryCompletedCredits")}</span>
        <div dir="ltr" className="flex items-baseline gap-1">
          <span className="font-display tabular text-3xl font-bold text-foreground/85">
            {completedCredits}
          </span>
          <span className="text-sm text-foreground/60">/ {totalTarget}</span>
        </div>
      ...
      <div className="space-y-2 sm:border-s sm:border-border/40 sm:ps-6">
        ...
        <Link
          href="/graduation"
          className="inline-flex items-center gap-1 text-[11px] leading-snug text-foreground/60 underline-offset-2 transition-colors hover:text-foreground/70 hover:underline"
        >
      ...
      {/* Focus-area progress */}
      <div className="space-y-2 sm:border-s sm:border-border/40 sm:ps-6">
        <span className="text-xs text-foreground/60">{t("summaryFocusCredits")}</span>
        {hasFocus ? (
          <>
            <div dir="ltr" className="flex items-baseline gap-1">
              <span className="font-display tabular text-3xl font-bold text-foreground/85">
              ...
              <span className="text-sm text-foreground/60">/ {focusTarget}</span>
            </div>
            <div className="h-1.5 w-full overflow-hidden rounded-full bg-foreground/10">
              <div
          ...
          <p className="pt-1 text-sm text-foreground/60">{t("summaryNoFocus")}</p>
        )}
      </div>
    </div>
  );
