  ...
  return (
    <div className={cn("block", className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        {/* טווח מספרי בתוך פסקה RTL — "80–100" נהפך ל-"100–80", כי המקף
            הוא תו נייטרלי והאלגוריתם הדו-כיווני סודר מחדש. מדדתי את זה על
            המסך החי אחרי הפריסה: הופיע "100-80". אותה משפחה בדיוק כמו
